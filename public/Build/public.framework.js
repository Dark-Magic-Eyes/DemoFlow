...
var ASM_CONSTS = {
  6638880: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 6638935: ($0) => { performance.now = function() { return $0; }; },  
 6638983: ($0) => { performance.now = function() { return $0; }; },  
 6639031: () => { performance.now = Module['emscripten_get_now_backup']; }
};
